        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../Dashboard/profile.php" aria-expanded="false">
            ...
            <li class="text-center p-20 upgrade-btn">
              <a href="../login/logout.php" class="btn d-grid btn-danger text-white" target="_blank">
                Logout</a>
            </li>
          </ul>
            ...
            <div class="col-lg-4">
              <div class="card mb-4">
                <div class="card-body text-center">
                  <img src="src/user.png" width="20px" height="20px" alt="avatar" class="rounded-circle img-fluid" style="width: 150px;">
